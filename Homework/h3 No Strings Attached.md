...
![screenshot]({DE4CC2CA-72C2-4A5A-923A-1A0CBD192E42}.png)
![screenshot]({4416CAB0-74CE-4975-88C1-31EA3EAB8600}.png)
![screenshot]({A04189C6-15B6-4389-846E-84EF5A1C4EAA}.png)
we use string to see whats going on in the executable
![screenshot]({81C42ABF-14C1-4869-9223-82C564893A37}.png)

we can see the password  and the flag by looking at it
![screenshot]({93DA2B7C-1FBE-4CA9-90E0-F1059388B617}.png)
i have just verified that it is the password and it is
![screenshot]({875CB415-4D6C-4DED-BDFE-67367937223B}.png)
...
![screenshot]({825C87EC-D17C-41A2-807F-AB3696FCB990}.png)


before :
![screenshot]({4360D2DD-AE91-4FDB-A862-7FA11EC61FED}.png)

after : 
![screenshot]({F99BF6BB-3F8A-4DCE-A96B-D84F90F9E638}.png)
...
![screenshot]({D82C9128-3AED-4A06-BEC9-8ABE42E38510}.png)

to see how it work i look at the the -h  and we see that -d decompress 


![screenshot]({CD0E32EC-8803-491F-8371-EB3A50B70791}.png)

we can now  upx -d packd


![screenshot]({13BAB210-FA8B-4D1E-A726-9127B54DA4F5}.png)

and now we can strings the file 
![screenshot]({7C6BFC17-EA40-4957-BA0D-2BD82F1BE1F9}.png)
now we have the password and the flag
![screenshot]({CA05582E-F954-436A-8905-AE5E44DA3B6A}.png)
